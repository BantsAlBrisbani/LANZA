...
if (isNil "ASOT_fnc_canRemove" || isNil "ASOT_fnc_removeObs" || isNil "ASOT_fnc_detonateObs_rigged") then {
	ASOT_fnc_canRemove = {
		params ["_obstacle"];
