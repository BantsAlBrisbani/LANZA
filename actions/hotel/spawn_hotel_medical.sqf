...
// This uses the mission file to generate the Arsenal inventory on each client rather than send it over the network.
private _jipID = ["ASOT_callFile", ["actions\hotel\code_arsenal.sqf",[_object ,"actions\hotel\items_medical.sqf", _text]]] call CBA_fnc_globalEventJIP;
