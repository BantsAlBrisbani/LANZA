...
private _wheelsCount = 8;

[_object, 2] call ace_cargo_fnc_setSize;
[_object, _wheelsCount] call ace_cargo_fnc_setSpace;

["ACE_Wheel", _object, _wheelsCount, true] call ace_cargo_fnc_addCargoItem;
[_object, "lockInventory", "noInventory", true] call ace_common_fnc_statusEffect_set;
[_object, "blockDamage", "noDamage", true] call ace_common_fnc_statusEffect_set;
